...
exports.createTables = function(dynamoDB, callback) {
    ...
    var configKey = config.const.s3prefix;
    var configSpec = {
        AttributeDefinitions : [ {
    ...
    var batchKey = config.const.batchId;
    var inputLoc = config.const.s3prefix;
    var batchSpec = {
        AttributeDefinitions : [ {
            ...
            AttributeName : conf.const.lastUpdate,
            AttributeType : 'N'
        }, {
        ...
        TableName : config.table.batch,
        ProvisionedThroughput : {
            ReadCapacityUnits : 1,
            WriteCapacityUnits : 5
        },
        GlobalSecondaryIndexes : [ {
            IndexName : config.const.batchStatusGSI,
            KeySchema : [ {
                AttributeName : 'status',
                KeyType : 'HASH'
            }, {
...
exports.getIntValue = function(value, rl) {
    if (!value || value === null) {
        ...
        process.exit(config.const.INVALID_ARG);
    } else {
...
exports.createManifestInfo = function(manifestConfig) {
    ...
    var manifestInfo = {
        manifestBucket : manifestConfig.manifestBucket.S,
        manifestKey : manifestConfig.manifestKey.S,
